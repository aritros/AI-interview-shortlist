...
const FILTERS = {
  ...
  skills2:  {k:'skills2', label:'Completed the design case', title:'Completed the design case', f:c=>!c.caseNA,
...
const INT_SECOND = {
  '360 Interview': {label:'Completed the design case', f:c=>!c.caseNA,
